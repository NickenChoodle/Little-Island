...
//BAKERY_ENABLED
  ...
  half3 RotateAroundYInDegrees (half3 toRotate, half degrees)
  {
    ...
    half3 reflDir = reflect(-d.worldSpaceViewDir, d.worldSpaceNormal);
    ...
    //our emission map
    half2 uv = round(globalUv * _SSSubPixel_ST.xy) / _SSSubPixel_ST.xy;
    half4 e = half4(probe0, 1);
    
    half vdn = dot(d.worldSpaceViewDir, d.worldSpaceNormal);

    //do RGB pixels
    uv = globalUv * _SSSubPixel_ST.xy + _SSSubPixel_ST.zw;
